...
import {
  ...
  getPublicEntranceExamQuestions,
...
export default function EntranceExamPortal() {
  ...
  const storageKey = `aas_entrance_exam_submitted_${code}`;
    ...
    (async () => {
      ...
      try {
        const [ex, qs] = await Promise.all([
          getPublicEntranceExam(code),
          getPublicEntranceExamQuestions(code, { shuffle: true }),
        ]);
    ...
    <div className="min-h-full bg-white">
      ...
      <main className="mx-auto w-full max-w-[1100px] px-4 py-8 md:px-8">
        ...
        {alreadySubmitted ? (
          ...
          <Panel className="mt-6 p-6 text-slate-700">No questions are published for this entrance exam.</Panel>
        ) : (
            ...
            <Panel className="p-5 lg:col-span-2">
              <div className="mb-4">
                ...
                <input
                  ...
                  placeholder="Enter your full name (must match your application record)"
                />
                <div className="mt-2 text-xs text-slate-600">
                  Your name must match exactly what was used during application registration.
                </div>
              </div>
